...
Atualmente, também estou expandindo meus conhecimentos para a área de tecnologia e desenvolvimento, explorando programação como uma ferramenta para criar soluções aplicadas ao meu dia a dia profissional.
...
Já desenvolvi meu primeiro projeto web utilizando:
...
💡 Desenvolvendo projetos próprios e novas soluções
...
«Automação, tecnologia e melhoria contínua.»
